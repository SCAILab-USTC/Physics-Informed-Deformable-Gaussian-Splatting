...
def render(viewpoint_camera, pc: GaussianModel, pipe, bg_color: torch.Tensor, d_xyz, d_rotation, d_scaling, enable_flow_grad,scaling_modifier=1.0, override_color=None):
    """
    Render the scene. 
    ...
    raster_settings = GaussianRasterizationSettings(
        ...
        prefiltered=False,
        debug=pipe.debug,
        enable_flow_grad=enable_flow_grad,
    )
    ...
    rendered_image, radii, depth, alpha, proj_means_2D, conic_2D, conic_2D_inv, gs_per_pixel, weight_per_gs_pixel, x_mu = rasterizer(
